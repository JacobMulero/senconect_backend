...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/private/var/www/senconect_backend/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
namespace SenConectBackend\Providers;
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'SenConectBackend\\Commands', 'SenConectBackend\\Handlers\\Commands');
        });
    }
    public function register()
    {
...
class RouteServiceProvider extends ServiceProvider
{
    protected $namespace = 'SenConectBackend\\Http\\Controllers';
    public function boot(Router $router)
    {
        parent::boot($router);
    }
